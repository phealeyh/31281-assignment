...
function confirmDelete() {
    if (confirm("Are you sure you wish to delete this Activity?") == true) {
        return true;
    } else {
...
<h2 id="positionTopH2">Update Details for Activity <?php echo $aName?></h2>

<pre id="instructions">
	General Instructions
</pre>
<pre id="preAlign2">
	To update an activity, change the details in the fields and click on Update.
	To remove an activity, click on Delete.
</pre>
...
<form name="newEvent" action="updateActivityProcessV.php?a_ID=<?php echo $aID; ?>" method="post" onsubmit="return checkForm()" class="createUser">
...
<input type="submit" class="redButton" value="Delete" id="deleteButton3">
</form>

<br>
<br>
<form action="manageActivity.php?a_ID=<?php echo $aID?>" method="post" id="backButton">
