...
if ($_SESSION['LoggedIn'] != $_SESSION['AdminCode'] && $_SESSION['LoggedIn'] !=$_SESSION['EMCode'] && $_SESSION['UserID']!=$uID) {
...
Thank you for volunteering for " . $aName . ", however this position has not been allocated to you.
