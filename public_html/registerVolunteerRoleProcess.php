...
//insert the user record into the database
$regID = $uID + $rID;
$update_SQL = "INSERT INTO `Registered` 
...
$subject = "Registration for " . $rName;
$message = "Hi " . $greeted . ", This is to confirm that we have received your role registration! We will review your application and inform you if you are allocated for the role as soon as possible.";
