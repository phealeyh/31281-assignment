...
<h2 id="positionTopH2">Update User Details</h2>
<pre id="instructions">
	General Instructions
</pre>
<pre id="preAlign2">
	To update a User, change the details in the fields and click on Update.
	To remove a User, click on Delete. <p id=nHead></p>
</pre>
...
<script>
function cantDelete() {
        alert("Cannot Delete: User is currently managing an active Event!");
        return false;
...
<label>
<span>Password</span>
<a href="resetPW.php?u_ID=<?php echo $guID; ?>" onclick="inform()">Reset</a>
</label>
...
<?php
     if ($_SESSION['LoggedIn'] == $_SESSION['AdminCode']) { //if they are an admin they can create another admin
         if ($guTP >=3) {
